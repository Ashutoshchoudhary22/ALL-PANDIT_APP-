...
export const APP_LANGUAGE_STORAGE_KEY = 'customer_app_language';
...
export function getPujaCategoryTranslationKey(label: string): TranslationKey | null {
  const map: Record<string, TranslationKey> = {
    'Marriage Puja': 'puja.marriagePuja',
    'Griha Pravesh': 'puja.grihaPravesh',
    'Satyanarayan Katha': 'puja.satyanarayanKatha',
    Havan: 'puja.havan',
    Rudrabhishek: 'puja.rudrabhishek',
    'Sunderkand Path': 'puja.sunderkandPath',
    More: 'puja.more',
  };
